...
- Dynamic return edges use typed envelopes (`TypedCap`) with producer-attached `SchemaBundle`; recursive allowlists are enforced schema-aware at RPC proxy boundaries.
